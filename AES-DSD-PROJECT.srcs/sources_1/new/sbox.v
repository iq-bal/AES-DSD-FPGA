// AES Forward S-box
// 256-entry LUT implementing the AES SubBytes substitution
// S-box constructed via GF(2^8) multiplicative inverse + affine transform
// Source: FIPS 197 Table 4, matches doc Appendix A.1
